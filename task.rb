...
def q11
  ...
  # 以下に回答を記載
  puts "ユーザーの趣味一覧"
  sports.flatten!.uniq!.each.with_index(1) do |value, index|
    puts "No.#{index} #{value}"
end
...
class UserQ17
  ...
  def initialize(name:"名前",age:"年齢",gender:"性別")
    @name = name
    @age = age
    @gender = gender
  end
